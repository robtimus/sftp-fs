...
public class SFTPFileSystemTest extends AbstractSFTPFileSystemTest {
    ...
    public void testReadSymbolicLinkToFile() throws IOException {
        ...
        SFTPPath link = getFileSystem().readSymbolicLink(createPath("/bar"));
    ...
    public void testCopySame() throws IOException {
        ...
        CopyOption[] options = {};
        getFileSystem().copy(createPath("/home"), createPath(""), options);
        getFileSystem().copy(createPath("/home/foo"), createPath("foo"), options);
        getFileSystem().copy(createPath("/home/foo/bar"), createPath("foo/bar"), options);
    ...
    public void testMoveSame() throws IOException {
        ...
        getFileSystem().move(createPath("/home"), createPath(""), options);
        getFileSystem().move(createPath("/home/foo"), createPath("foo"), options);
        getFileSystem().move(createPath("/home/foo/bar"), createPath("foo/bar"), options);
        getFileSystem().move(createPath("/home/foo"), createPath("/baz"), options);
        getFileSystem().move(createPath("/baz"), createPath("/home/foo"), options);
    ...
    public void testIsSameFileEquals() throws IOException {
        ...
        assertTrue(getFileSystem().isSameFile(createPath(""), createPath("/home")));
        assertTrue(getFileSystem().isSameFile(createPath("/home"), createPath("")));
    }
    ...
    public void testIsSameFileExisting() throws IOException {
        ...
        assertTrue(getFileSystem().isSameFile(createPath("/home"), createPath("")));
        assertTrue(getFileSystem().isSameFile(createPath("/home/foo"), createPath("foo")));
        assertTrue(getFileSystem().isSameFile(createPath("/home/foo/bar"), createPath("foo/bar")));

        assertTrue(getFileSystem().isSameFile(createPath(""), createPath("/home")));
        assertTrue(getFileSystem().isSameFile(createPath("foo"), createPath("/home/foo")));
        assertTrue(getFileSystem().isSameFile(createPath("foo/bar"), createPath("/home/foo/bar")));

        assertFalse(getFileSystem().isSameFile(createPath("foo"), createPath("foo/bar")));

        assertTrue(getFileSystem().isSameFile(createPath("/bar"), createPath("/home/foo/bar")));
    }
    ...
    public void testSetOwnerNonExisting() throws IOException {
        try {
            getFileSystem().setOwner(createPath("/foo/bar"), new SimpleUserPrincipal("1"));
        } finally {
    ...
    public void testSetOwnerNonNumeric() throws IOException {
        ...
        try {
            getFileSystem().setOwner(createPath("/foo/bar"), new SimpleUserPrincipal("test"));
        } catch (IOException e) {
    ...
    public void testSetGroupNonExisting() throws IOException {
        try {
            getFileSystem().setGroup(createPath("/foo/bar"), new SimpleGroupPrincipal("1"));
        } finally {
    ...
    public void testSetGroupNonNumeric() throws IOException {
        ...
        try {
            getFileSystem().setGroup(createPath("/foo/bar"), new SimpleGroupPrincipal("test"));
        } catch (IOException e) {
            assertThat(e.getCause(), instanceOf(NumberFormatException.class));
            throw e;
        } finally {
    ...
    public void testSetPermissionsNonExisting() throws IOException {
        try {
            getFileSystem().setPermissions(createPath("/foo/bar"), PosixFilePermissions.fromString("r--r--r--"));
        } finally {
    ...
    public void testSetLastModifiedTimeExisting() throws IOException {
        ...
        getFileSystem().setLastModifiedTime(path, lastModifiedTime, false);
        assertEquals(lastModifiedTime, getFileSystem().readAttributes(path).lastModifiedTime());
    }

    @Test(expected = FileSystemException.class)
    public void testSetLastModifiedTimeNonExisting() throws IOException {
        try {
            getFileSystem().setLastModifiedTime(createPath("/foo/bar"), FileTime.from(123456789L, TimeUnit.SECONDS), false);
        } finally {
    ...
    public void testSetAttributeLastModifiedTime() throws IOException {
        ...
        getFileSystem().setAttribute(fooPath, "basic:lastModifiedTime", lastModifiedTime);
        assertEquals(lastModifiedTime, Files.getLastModifiedTime(foo));

        lastModifiedTime = FileTime.from(1234567L, TimeUnit.SECONDS);

        getFileSystem().setAttribute(fooPath, "posix:lastModifiedTime", lastModifiedTime);
        assertEquals(lastModifiedTime, Files.getLastModifiedTime(foo));

        lastModifiedTime = FileTime.from(12345678L, TimeUnit.SECONDS);

        getFileSystem().setAttribute(fooPath, "lastModifiedTime", lastModifiedTime);
        assertEquals(lastModifiedTime, Files.getLastModifiedTime(foo));
    }
    ...
    public void testSetAttributeUnsupportedAttribute() throws IOException {
        ...
        getFileSystem().setAttribute(createPath("/foo"), "basic:creationTime", true);
    }
    ...
    public void testSetAttributeUnsupportedType() throws IOException {
        ...
        getFileSystem().setAttribute(createPath("/foo"), "zipfs:size", true);
    }
    ...
    public void testSetAttributeInvalidValueType() throws IOException {
        ...
        getFileSystem().setAttribute(createPath("/foo"), "basic:lastModifiedTime", 1);
    }
